...
export const NewUserSchema = () => {
  return Yup.object().shape({
    ...
    zip_code: Yup.string()
      .matches(/^\d{4,5}$/, 'El código postal debe tener 3 o 5 números')
      .min(4, 'El código postal debe tener más de 3 caracteres')
      .required('El codigo postal es obligatorio'),
    shipping_address: Yup.string().required('Dirección obligatoria'),
